...
void loop() {
  ...
  Serial.println();
   ...
   int val = CrcLib::ReadAnalogChannel(ANALOG::JOYSTICK1_X);
  val = map(val, -128, 127, -60, 60);
  

  if (CrcLib::IsCommValid())
  {
    Serial.print(" LeftStick(x,y,press): ("); Serial.print(val); Serial.print(","); Serial.print(CrcLib::ReadAnalogChannel(ANALOG::JOYSTICK1_Y)) ; Serial.print(","); Serial.print(CrcLib::ReadDigitalChannel(BUTTON::HATL));
