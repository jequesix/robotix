...
class Wheels {
  ...
  public:    
    Wheels(CrcUtility::ANALOG throttleBinding, CrcUtility::ANALOG sideBinding, CrcUtility::ANALOG rotationBinding, byte frontLeftMCPin, byte backLeftMCPin, byte frontRightMCPin, byte backRightMCPin) : 
