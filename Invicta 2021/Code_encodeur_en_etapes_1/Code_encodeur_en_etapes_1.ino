...
void rotation_encodeur(int POSITION,char V_AVANCER, int V_INVERSE){
  ...
  {
    CrcLib::SetPwmOutput(Motor_control_1,V_INVERSE);
 GLOBALE = POSITION;
